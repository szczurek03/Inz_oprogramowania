...
$plan_details = [
    'Regular' => ['id_nazwa_subskrybcji' => 2, 'cena' => 39.99, 'aktywny' => 1, 'data_zakończenia' => date('Y-m-d', strtotime('+30 days'))],
    'Premium' => ['id_nazwa_subskrybcji' => 3, 'cena' => 59.99, 'aktywny' => 1, 'data_zakończenia' => date('Y-m-d', strtotime('+30 days'))],
    'Brak' => ['id_nazwa_subskrybcji' => 1, 'cena' => 0, 'aktywny' => 0, 'data_zakończenia' => date('Y-m-d')]
];
